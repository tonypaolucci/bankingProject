...
<div class="w3-main" style="margin-left:250px">
  ...
  <div class="w3-row w3-padding-64">
    <div class="w3-twothird w3-container">
      ...
      <h2 class="w3-text-teal"  class="uLine">Open Account</h2>   
   <div class="row">
  <form class="formContainer" action= "OpenAccountServlet" method= "post">
  <div class="form-group">
    <label for="startBal">Starting Balance<span class="redClass">*</span></label>
    <input type="text" class="form-control" id="startBal" name="startBal"  placeholder="Ammount">
  </div>
   <div>
   <select name="accountType" id=accountType onchange="document.productForm.submit();" placeholder="Account Type">
<!--         <option value="dropdown">Account Type -->
