...
<!-- 			   <button type="submit" class="btn btn-default">Click here</button>
 -->          <p><a class="btn btn-default" href=".\acctOpen.html" role="button">Click here &raquo;</a></p>
            </div><!--/.col-xs-6.col-lg-4-->
            <div class="col-xs-6 col-lg-4">
              <h2>Close account</h2>
              <p>Really pillage youre account. </p><br>
			   <!-- <button type="submit" class="btn btn-default">Click here</button> -->
              <p><a class="btn btn-default" href=".\acctClose.html" role="button">Click here &raquo;</a></p>
            </div><!--/.col-xs-6.col-lg-4-->
            <div class="col-xs-6 col-lg-4">
